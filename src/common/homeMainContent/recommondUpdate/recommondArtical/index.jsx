...
export default function RecommondArtical({
  artucalInfo = {
    ...
    img: {
      url: 'https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/a2c68eed94124e9faeaabc8602fd6c07~tplv-k3u1fbpfcp-no-mark:240:240:240:160.awebp?',
      alt: '作为前端应该了解的后端常识'
    }
  } }) {
  const { author, time, classification, url, title, content, img } = artucalInfo
  ...
  return (
    <div className='recommondArtical__div--container'>
      <div className='recommondArtical__div--line'>
        ...
        <img className='recommondArtical__img--artical' src={img.url} alt={img.alt} />
      </div>
    </div>
  )
}
